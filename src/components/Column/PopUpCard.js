...
class PopUpCard extends Component {
  ...
  addComment = (task, event) => {
    ...
    const username = localStorage.getItem('username');
    const commentArray = JSON.parse(localStorage.getItem('commentArr_' + task));
            ...
            <div id="content_window" className="col-md-auto">
              <div>
                <button
                  ...
                  aria-label="Close"
                  onClick={evt => close(idWindow)}
                >
                  <span aria-hidden="true">&times;</span>
                </button>
                <div className="  justify-content-md-center">
                  {' '}
                  <h2> {localStorage.getItem(columnId + 'name')} </h2>{' '}
                </div>
              </div>
              ...
              <div className="  justify-content-md-center">
                  ...
                  id={comments}
                  onChange={onChange}
                  value={localStorage.getItem('comments_' + task)}
